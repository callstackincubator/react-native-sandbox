...
/**
 * A C++ TurboModule stub implementation that intercepts all method calls for
 * blocked modules. This prevents crashes when sandbox code tries to access
 * disallowed modules while logging warnings.
 */
class StubTurboModuleCxx : public TurboModule {
 public:
   ...
   * This is the main method that gets called for any TurboModule method
   * invocation
   */
 ...
 private:
   ...
   */
  jsi::Function createStubFunction(
      jsi::Runtime& runtime,
